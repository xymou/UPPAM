...
class JointSeqTrainer(Trainer):
    ...
    def evaluate(
        ...
        # eval on pre-training eval_dataset
        ...
        if not isinstance(self.model, PreTrainedModel) and isinstance(self.model.encoder, PreTrainedModel):
        ...
        if eval_senteval_transfer or self.args.eval_transfer:
            ...
            tasks = ['PUB_STANCE_poldeb','LEG_BIAS_cong']
    ...
    def prediction_loop(
        ...
        for step, inputs in enumerate(dataloader):
            inputs['sent_emb'] = self.args.sent_emb
            inputs['aggr_emb'] = self.args.aggr_emb
            inputs['aggr_cl'] = self.args.aggr_cl
            inputs['act'] = self.args.act
            inputs['a_sent_emb'] = self.args.a_sent_emb
            inputs['a_aggr_emb'] = self.args.a_aggr_emb
            inputs['a_aggr_cl'] = self.args.a_aggr_cl
            inputs['b_sent_emb'] = self.args.b_sent_emb
            inputs['b_aggr_emb'] = self.args.b_aggr_emb
            inputs['b_aggr_cl'] = self.args.b_aggr_cl
            inputs['leg_sent_emb'] = self.args.leg_sent_emb
            inputs['leg_aggr_emb'] = self.args.leg_aggr_emb
            inputs['leg_aggr_cl'] = self.args.leg_aggr_cl  
            inputs['leg_act'] = self.args.leg_act           
    ...
    def prediction_step(
        ...
        with torch.no_grad():
            ...
            if has_labels or (outputs.loss is not None):
    ...
    def _remove_unused_columns(self, dataset: "datasets.Dataset", description: Optional[str] = None):
        ...
        signature_columns += ["label", "label_ids", "token_span", "frame_info", "entity_info"]
