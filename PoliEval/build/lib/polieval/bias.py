...
class BIASSeqEval(object):
    ...
    def loadFile(self, path):
        if 'cong_records' in path or 'congs' in path:
            mem, label = [],[]
            with open('../data/PUB_BIAS/cong_records/objspeaker2text.pkl','rb') as f:
                text = pickle.load(f)
            with open('../data/PUB_BIAS/cong_records/objspeaker2label.pkl','rb') as f:
            ...
            mem, label = [],[]
            with open('../data/PUB_BIAS/TIMME/objspeaker2text.pkl','rb') as f:
                text = pickle.load(f)
            with open('../data/PUB_BIAS/TIMME/objspeaker2label.pkl','rb') as f:
                labels = pickle.load(f)
            with open(path, 'r') as f:
                for line in f.readlines():
                    speaker_id = line.strip()
            ...
            mem, label = [],[]
            with open('../data/PUB_BIAS/PEM/objspeaker2text.pkl','rb') as f:
                text = pickle.load(f)
            with open('../data/PUB_BIAS/PEM/objspeaker2label.pkl','rb') as f:
                labels = pickle.load(f)
            with open(path, 'r') as f:
                for line in f.readlines():
                    speaker_id = line.strip()
            ...
            ltype = path.split('/')[-2]
            ltype='eco'
            with open('/remote-home/xymou/poliexpert/mert/PoliEval/data/PUB_BIAS/reddit/'+ltype+'/'+'objspeaker2text.pkl','rb') as f:
                text = pickle.load(f)
            with open('/remote-home/xymou/poliexpert/mert/PoliEval/data/PUB_BIAS/reddit/'+ltype+'/'+'objspeaker2label.pkl','rb') as f:
                labels = pickle.load(f)
            with open(path, 'r') as f:
                for line in f.readlines():
                    speaker_id = line.strip()
