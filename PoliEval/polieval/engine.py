...
class SE(object):
    def __init__(self, params, encoder):
        ...
        params.model_name_or_path = 'roberta-base' if 'model_name_or_path' not in params else params.model_name_or_path
    ...
    def eval(self, name):
        ...
        if name == 'MEDIA_FRAME_gvfc':
            ...
            self.evaluation = BIASSeqEval(tpath + '/LEG_BIAS/cong_records/', self.params, copy.deepcopy(self.encoder))            
        elif name == 'GRADE_LCV':
